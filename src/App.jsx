      ...
      <div className="container">
        ...
        <div className="main-content">
          ...
          <p className="description">
            Test your spelling skills in the ultimate gauntlet! Spell words correctly and advance, but get one wrong, and <span style={{ color: 'blue' }}></span>you lose! Aim for the highest score and top the leaderboard!
          </p>
